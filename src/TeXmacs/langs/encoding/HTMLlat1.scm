...
("nbsp"         "&#x00A0")      ; no-break space = non-breaking space
("iexcl"        "&#x00A1")      ; inverted exclamation mark
("cent"         "&#x00A2")      ; cent sign
("pound"        "&#x00A3")      ; pound sign
("curren"       "&#x00A4")      ; currency sign
("yen"          "&#x00A5")      ; yen sign = yuan sign
("brvbar"       "&#x00A6")      ; broken bar = broken vertical bar
("sect"         "&#x00A7")      ; section sign
("uml"          "&#x00A8")      ; diaeresis = spacing diaeresis
("copy"         "&#x00A9")      ; copyright sign
("ordf"         "&#x00AA")      ; feminine ordinal indicator
("laquo"        "&#x00AB")      ; left-pointing double angle quotation mark
("not"          "&#x00AC")      ; not sign
("shy"          "&#x00AD")      ; soft hyphen = discretionary hyphen
("reg"          "&#x00AE")      ; registered sign = registered trade mark sign
("macr"         "&#x00AF")      ; macron = spacing macron = overline
("deg"          "&#x00B0")      ; degree sign
("plusmn"       "&#x00B1")      ; plus-minus sign = plus-or-minus sign
("sup2"         "&#x00B2")      ; superscript two = superscript digit two
("sup3"         "&#x00B3")      ; superscript three = superscript digit three
("acute"        "&#x00B4")      ; acute accent = spacing acute
("micro"        "&#x00B5")      ; micro sign
("para"         "&#x00B6")      ; pilcrow sign = paragraph sign
("middot"       "&#x00B7")      ; middle dot = Georgian comma
("cedil"        "&#x00B8")      ; cedilla = spacing cedilla
("sup1"         "&#x00B9")      ; superscript one = superscript digit one
...
("szlig"        "&#x00DF")      ; latin small letter sharp s = ess-zed
